(function () {
  const projects = [
    {
      title: 'BubbleShooter',
      image: './img/projects/bubbleshooter.png',
      imageAlt: 'BubbleShooter Project Cover Photo',
      description: 'In the game-based learning website, take bubble-defying games as an example, let students learn by playing games, use games and image memory to increase the effectiveness of learning, and make it easier for teachers to grasp the learning status of students',
      badgeCaption: 'BubbleShooter',
      links: {
        github: 'https://github.com/dacky486/bubbleshooter'
      },
      accomplishments: [
        'Built with Bootstrap, JavaScript,PHP',
        'Using AJAX,Jquery',
        'MySQL',
      ]
    }
